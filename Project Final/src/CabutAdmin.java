...
public class CabutAdmin extends JFrame {
    ...
    JButton Cabut = new JButton("Hapus");
    ...
    public CabutAdmin(int b, String N){
        ...
        //Tombol
        add(Kembali);add(Edit);add(Cabut);
        ...
        Cabut.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent ae) {
                if(status==1){
                    JOptionPane.showMessageDialog(null, "Data Harus disimpan terlebih dahulu", "Peringatan!", JOptionPane.WARNING_MESSAGE);
                }else{
                    Delete();
                    new MainFrame().setVisible(true);dispose();
                }
